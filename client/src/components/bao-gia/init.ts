...
export const options: Option[] = [
	...
	},
	{
		...
		children: [
			...
			{
				value: 'ford-ranger-xls-2-0l-4x2-at',
				label: 'Ford Ranger XLS 2.0L 4X2 AT',
			},
			{
				value: 'ford-ranger-xls-2-0l-4x4-at',
				label: 'Ford Ranger XLS 2.0L 4X4 AT',
			},
			{
				value: 'ford-ranger-xlt-2-0l-4x2-at',
				label: 'Ford Ranger SPORT 2.0L 4X4 AT',
			},
			{
				value: 'ford-ranger-xlt-2-0l-4x4-at',
				label: 'Ford Ranger WILDTRAK 2.0L 4X4 AT',
			},
			{
				value: 'ford-ranger-xlt-2-0l-4x4-at',
				label: 'Ford Ranger STORMTRAK 2.0L 4X4 AT',
			},
		],
	},
	{
